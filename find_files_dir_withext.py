...
import os
import sys
req_path=input("Enter requested path: ")
#req_ex=input("Enter the required files extension .py/.sh/.txt: ")

if os.path.isfile(req_path):
    print(f"The given path {req_path} is file. please pass only directory path")
else:
